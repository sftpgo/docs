...
- [v2.7.3, v2.7, v2, latest](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile){:target="_blank"}
- [v2.7.3-plugins, v2.7-plugins, v2-plugins, plugins](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile){:target="_blank"}
- [v2.7.3-alpine, v2.7-alpine, v2-alpine, alpine](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile.alpine){:target="_blank"}
- [v2.7.3-slim, v2.7-slim, v2-slim, slim](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile){:target="_blank"}
- [v2.7.3-alpine-slim, v2.7-alpine-slim, v2-alpine-slim, alpine-slim](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile.alpine){:target="_blank"}
- [v2.7.3-distroless-slim, v2.7-distroless-slim, v2-distroless-slim, distroless-slim](https://github.com/drakkan/sftpgo/blob/2.7.x/Dockerfile.distroless){:target="_blank"}
