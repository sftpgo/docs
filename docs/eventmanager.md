---
description: "Open-source SFTPGo Event Manager: automate file transfer workflows with rules triggered by uploads, downloads, schedules, and provider changes."
---
