---
description: "Run a custom action when a new connection is established in open-source SFTPGo, before authentication. Use for IP-based access control or logging."
---
