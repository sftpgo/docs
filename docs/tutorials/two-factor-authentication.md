---
description: "Enable two-factor authentication (TOTP) in open-source SFTPGo for users and administrators, compatible with Google Authenticator, Microsoft Authenticator, and Authy."
---
