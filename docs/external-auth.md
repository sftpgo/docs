---
description: "Authenticate SFTPGo users via external programs or HTTP endpoints. Supports LDAP, Active Directory, custom databases, and any external identity source."
---
