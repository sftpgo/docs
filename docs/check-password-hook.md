---
description: "Validate user passwords in open-source SFTPGo with an external hook. Useful for password+OTP on protocols that do not support keyboard-interactive authentication."
---
